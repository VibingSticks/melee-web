...
#ifdef TARGET_PC
s32 mnCharSel_802640A0(void); /* returns s32; the void spelling below is a
                               * second declaration of the same function and
                               * wasm will not link two shapes of one name */
#else
